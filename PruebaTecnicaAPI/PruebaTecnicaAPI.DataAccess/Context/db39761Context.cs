...
namespace PruebaTecnicaAPI.DataAccess.Context;

public partial class db39761Context : DbContext
{
    public db39761Context(DbContextOptions<db39761Context> options)
        : base(options)
    {
    }


    public db39761Context()
    {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ClienteId).HasName("PK__Cliente__71ABD087A9CFB978");

            entity.ToTable("Cliente");

            entity.HasIndex(e => e.Identidad, "UQ__Cliente__5C06DCB4923D2128").IsUnique();
        ...
        {
            entity.HasKey(e => e.DetalleOrdenId).HasName("PK__DetalleO__EE6A3A814C237386");
        ...
        {
            entity.HasKey(e => e.OrdenId).HasName("PK__Orden__C088A504B887F487");
        ...
        {
            entity.HasKey(e => e.ProductoId).HasName("PK__Producto__A430AEA35FBCA5A9");
